...
{% hint style="warning" %}
If you followed the [get-started.md](get-started.md "mention") guide for Flutter, then you should already have onboarding setup in your app. Feel free to skip this section and move on.
{% endhint %}
