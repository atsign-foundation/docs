---
description: >-
  This page summarizes the latest features and bug fixes to help you understand
...
_New example blueprint!_&#x20;

Jump into the [**Grocery List blueprint**](ai-architect-walkthroughs/how-to-think-when-creating-a-blueprint.md) to quickly see how to structure and connect your ideas.
{% endhint %}
{% endupdate %}
...
{% hint style="info" icon="lightbulb" %}
_Not sure what a button does? Hover over it for a hint._
{% endhint %}
{% endupdate %}
{% endupdates %}
